// Traffic sign classes available for annotation
export const TRAFFIC_SIGN_CLASSES = [
...
export const TRAFFIC_SIGN_CATEGORIES = {
    'Complementary': TRAFFIC_SIGN_CLASSES.filter(cls => cls.startsWith('complementary--')),
    'Information': TRAFFIC_SIGN_CLASSES.filter(cls => cls.startsWith('information--')),
    'Regulatory': TRAFFIC_SIGN_CLASSES.filter(cls => cls.startsWith('regulatory--')),
    'Warning': TRAFFIC_SIGN_CLASSES.filter(cls => cls.startsWith('warning--'))
};
