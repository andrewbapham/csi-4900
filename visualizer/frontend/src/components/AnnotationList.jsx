...
import { CheckCircle, XCircle, Edit3, Save, Trash } from "lucide-react";
      ...
      <div className="annotations-list">
        {annotations.map((annotation, index) => (
          <div
            ...
            } ${hoveredAnnotation === index ? "hovered" : ""} ${
              selectedAnnotation === index ? "selected" : ""
            }`}
            ...
            <div className="annotation-main">
              <div className="annotation-info">
                <span className="class-name">
                  {formatClassName(annotation.class)}
                </span>
                ...
                {editingAnnotation === index ? (
                  <button
                    ...
                    onClick={(e) => {
                      ...
                      saveAnnotationEdit(
                        index,
                        document.querySelector(".edit-form input").value
                      );
                    }}
                    title="Save"
                  >
