...
LABEL_TO_CLASS = {
    ...
    'regulatory--no-parking--g9': 'no_parking',
    ...
    'regulatory--one-way-right--g3': 'one_way_right',
    ...
    'regulatory--go-straight-or-turn-left--g1': 'go_straight_or_turn_left',
    'regulatory--go-straight-or-turn-left--g2': 'go_straight_or_turn_left',
    'regulatory--go-straight-or-turn-left--g3': 'go_straight_or_turn_left',
    'regulatory--go-straight-or-turn-right--g1': 'go_straight_or_turn_right',
    'regulatory--go-straight-or-turn-right--g2': 'go_straight_or_turn_right',
    'regulatory--go-straight-or-turn-right--g3': 'go_straight_or_turn_right',
    'regulatory--turn-left-ahead--g1': 'turn_left_ahead',
    'regulatory--turn-left-ahead--g2': 'turn_left_ahead',
    'regulatory--turn-right-ahead--g1': 'turn_right_ahead',
    'regulatory--turn-right-ahead--g2': 'turn_right_ahead',
    ...
    'information--parking--g2': 'parking',
    'information--parking--g3': 'parking',
    'information--parking--g4': 'parking',
    'information--parking--g5': 'parking',
    'information--parking--g6': 'parking',
    'information--disabled-persons--g1': 'disabled_persons',
    'information--hospital--g1': 'hospital',
    'information--bike-route--g1': 'bike_route',
    'information--bike-route--g2': 'bike_route',
    ...
    'warning--turn-right--g1': 'turn_left_warning',  # Note: README shows turn-right but maps to turn_left_warning
    'warning--turn-right--g3': 'turn_left_construction',  # Note: README shows turn-right but maps to turn_left_construction
    'warning--turn-right--g1': 'turn_right_warning',
    'warning--turn-right--g3': 'turn_right_construction',
    'warning--trucks-rollover--g1': 'trucks_rollover',
    'warning--trucks-rollover--g2': 'trucks_rollover',
    'warning--trucks-rollover--g3': 'trucks_rollover',
    'warning--trucks-rollover--g4': 'trucks_rollover',
    'warning--trucks-rollover--g5': 'trucks_rollover',
    ...
    'warning--texts--g2': 'text_warning',
    'warning--texts--g3': 'text_warning',
    ...
    'warning--road-bump--g3': 'speed_bump_ahead',
    ...
    'complementary--chevron-left--g2': 'chevron_left',
    'complementary--chevron-left--g3': 'chevron_left',
    'complementary--chevron-left--g4': 'chevron_left',
    'complementary--chevron-left--g5': 'chevron_left',
    'complementary--chevron-right--g1': 'chevron_right',
    'complementary--chevron-right--g2': 'chevron_right',
    'complementary--chevron-right--g3': 'chevron_right',
    'complementary--chevron-right--g4': 'chevron_right',
    'complementary--chevron-right--g5': 'chevron_right',
